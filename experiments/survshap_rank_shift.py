...
fig.tight_layout()
fig.savefig(FIGS / "fig35_static_vs_survshap_rank.png", dpi=300)
plt.close(fig)
...
fig.tight_layout()
fig.savefig(FIGS / "fig36_rank_shift_12_to_60.png", dpi=300)
plt.close(fig)
...
fig.tight_layout()
fig.savefig(FIGS / "fig37_early_vs_late_drivers.png", dpi=300)
plt.close(fig)
